            ...
            <form @submit.prevent>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="mb-4 flex flex-col">
                  ...
                  <fwb-button v-if="!data.form.userId || data.form.userId=='NULL'" @click="createAccount">Buat Akun</fwb-button>
                  <fwb-button v-if="data.form.userId && data.form.userId!='NULL'" @click="resetPassword">Reset Password</fwb-button>
                </div>
              </div>
            </form>
