<template>
  <div class="overflow-hidden">
    <button type="button"
      ...
      aria-controls="dropdown-content" @click="toggleDropdown">
      <slot name="icon">
        <svg
          class="size-1 shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
      ...
      <slot name="arrow-icon" :toggle-dropdown="toggleDropdown">
        <svg class="w-4 transition-all duration-300" :class="isOpen && 'rotate-180'" aria-hidden="true"
